...
const scriptsInEvents = {
	...
	async EsHome_Event45_Act1(runtime, localVars)
	{
		window.Telegram.WebApp.openTelegramLink('https://t.me/gs_community')
	},

	async EsMain_Event6_Act1(runtime, localVars)
	{
		runtime.globalVars.language_code = user.language_code;
	},

	async EsMain_Event16_Act1(runtime, localVars)
	{
	...
	async EsLoad_Event1_Act5(runtime, localVars)
	{
