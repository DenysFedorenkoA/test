...
const scriptsInEvents = {
	...
	async EsHomeevents_Event33_Act1(runtime, localVars)
	{
		window.Telegram.WebApp.platform
	},

	async EsHomeevents_Event33_Act2(runtime, localVars)
	{
		window.Telegram.WebApp.colorScheme
	},

	async EsHomeevents_Event33_Act3(runtime, localVars)
	{
		window.Telegram.WebApp.themeParams
	},

	async EsHomeevents_Event33_Act4(runtime, localVars)
	{
		window.Telegram.WebApp.isExpanded
	},

	async EsHomeevents_Event33_Act5(runtime, localVars)
	{
		window.Telegram.WebApp.viewportHeight
	},

	async EsHomeevents_Event33_Act6(runtime, localVars)
	{
		window.Telegram.WebApp.viewportStableHeight
	},

	async EsHomeevents_Event33_Act7(runtime, localVars)
	{
		window.Telegram.WebApp.headerColor
	},

	async EsHomeevents_Event33_Act8(runtime, localVars)
	{
		window.Telegram.WebApp.backgroundColor
	},

	async EsHomeevents_Event33_Act9(runtime, localVars)
	{
		window.Telegram.WebApp.isClosingConfirmationEnabled
	},

	async EsHomeevents_Event33_Act10(runtime, localVars)
	{
		window.Telegram.WebApp.BackButton
	},

	async EsHomeevents_Event33_Act11(runtime, localVars)
	{
		window.Telegram.WebApp.MainButton
	},

	async EsHomeevents_Event33_Act12(runtime, localVars)
	{
		window.Telegram.WebApp.SettingsButton
	},

	async EsHomeevents_Event33_Act13(runtime, localVars)
	{
		window.Telegram.WebApp.HapticFeedback
	},

	async EsHomeevents_Event33_Act14(runtime, localVars)
	{
		window.Telegram.WebApp.CloudStorage
	},

	async EsHomeevents_Event33_Act15(runtime, localVars)
	{
		window.Telegram.WebApp.BiometricManager 
	},

	async EsHomeevents_Event33_Act16(runtime, localVars)
	{
		window.Telegram.WebApp.isVersionAtLeast(version) 
	},

	async EsHomeevents_Event33_Act17(runtime, localVars)
	{
		window.Telegram.WebApp.onEvent(eventType, eventHandler)
	},

	async EsHomeevents_Event33_Act18(runtime, localVars)
	{
		window.Telegram.WebApp.offEvent(eventType, eventHandler)
	},

	async EsHomeevents_Event33_Act19(runtime, localVars)
	{
		window.Telegram.WebApp.sendData(data)
	},

	async EsHomeevents_Event33_Act20(runtime, localVars)
	{
		window.Telegram.WebApp.switchInlineQuery(query[ choose_chat_types])
	},

	async EsHomeevents_Event33_Act21(runtime, localVars)
	{
		window.Telegram.WebApp.openInvoice(url[ callback])
	},

	async EsHomeevents_Event33_Act22(runtime, localVars)
	{
		window.Telegram.WebApp.showPopup(params[ callback])
	},

	async EsHomeevents_Event33_Act23(runtime, localVars)
	{
		window.Telegram.WebApp.showScanQrPopup("test3"[ callback])
	},

	async EsHomeevents_Event33_Act24(runtime, localVars)
	{
		window.Telegram.WebApp.closeScanQrPopup()
	},

	async EsHomeevents_Event33_Act25(runtime, localVars)
	{
		window.Telegram.WebApp.readTextFromClipboard([callback])        
	},

	async EsHomeevents_Event33_Act26(runtime, localVars)
	{
		window.Telegram.WebApp.requestWriteAccess([callback])
	},

	async EsHomeevents_Event33_Act27(runtime, localVars)
	{
	...
	async EsHomeevents_Event42(runtime, localVars)
	{
		window.Telegram.WebApp.onEvent('popupClosed', function(){
			window.Telegram.WebApp.sendData("yes4");});
	},

	async EsHomeevents_Event47_Act1(runtime, localVars)
	{
		window.Telegram.WebApp.ready()
	},

	async EsHomeevents_Event47_Act2(runtime, localVars)
	{
		window.Telegram.WebApp.expand()
	},

	async EsHomeevents_Event47_Act3(runtime, localVars)
	{
		window.Telegram.WebApp.enableClosingConfirmation()
	},

	async EsHomeevents_Event47_Act4(runtime, localVars)
	{
		window.Telegram.WebApp.disableVerticalSwipes()
	},

	async EsHomeevents_Event47_Act6(runtime, localVars)
	{
		  const search = new URLSearchParams(decodeURIComponent(window.Telegram.WebApp.initData));
		  console.log(search);
		  const user = JSON.parse(search.get('user'));
	...
	async EsHomeevents_Event89_Act7(runtime, localVars)
	{
		window.Telegram.WebApp.openTelegramLink(runtime.globalVars.TGINVITEURL)
	},

	async EsHomeevents_Event108_Act1(runtime, localVars)
	{
